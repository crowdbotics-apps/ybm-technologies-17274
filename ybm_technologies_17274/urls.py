"""ybm_technologies_17274 URL Configuration
...
admin.site.site_header = "YBM Technologies"
admin.site.site_title = "YBM Technologies Admin Portal"
admin.site.index_title = "YBM Technologies Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="YBM Technologies API",
        default_version="v1",
        description="API documentation for YBM Technologies App",
    ),
    public=True,
